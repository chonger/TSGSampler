...
object Util {
    ...
    /**
     * A hash map for analysis of a hash function.
     *
     * Uses this class so we can access private HashMap members.
     *
     * Analysis is performed with the AnalyzeHashMap function
     *
     */ 
